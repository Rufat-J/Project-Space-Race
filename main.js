...
let bullet1 = new Bullets(new Position(player1.position.x, player1.position.y), 5, new Velocity(100))
let bullet2 = new Bullets(new Position(player2.position.x, player2.position.y), 5, new Velocity(100) )
