...
export class Players extends Entity {
  ...
  respawn1() {
    player1 = new Players(new Position(200, 515), 20)
  }

  respawn2() {
    player2 = new Players(new Position(400, 515), 20);
  }
...
export let player1 = new Players(new Position(200, 515), 20);
export let player2 = new Players(new Position(400, 515), 20);